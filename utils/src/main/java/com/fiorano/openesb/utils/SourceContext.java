...
/**
 *  Contains information about the service instance sending the data packet. The
 *  target instance identifies the sender of the data packet from this
 *  information within the <code>DataPacket</code>.
 *
