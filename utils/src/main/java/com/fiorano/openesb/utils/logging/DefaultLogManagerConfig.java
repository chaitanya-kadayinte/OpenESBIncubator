...
/**
 * Configuration object for Default LogHandleManager
 *
 * @author FSIPL
 * @created March 31, 2005
 * @version 1.0
 * @jmx.mbean description="Configuration object for Default LogHandleManager"
 * @jmx.descriptor name="ID" value="LOG_STORE"
 */
