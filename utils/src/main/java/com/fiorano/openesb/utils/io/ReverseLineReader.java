...
public class ReverseLineReader implements Closeable {
     ...
     */
    public ReverseLineReader(final File file) throws IOException {
        this(file, 4096, FIORANO_LOG_FILE_ENCODING!=null ? FIORANO_LOG_FILE_ENCODING : Charset.defaultCharset().toString());
    }
     ...
     * @since 2.3
     */
    public ReverseLineReader(final File file, final int blockSize, final Charset encoding) throws IOException {
        this(new RandomAccessFile(file,"r"),blockSize,encoding);
    }

    public ReverseLineReader(RandomAccessFile randomAccessFile) throws IOException {
        this(randomAccessFile,4096, FIORANO_LOG_FILE_ENCODING!=null ? Charset.forName(FIORANO_LOG_FILE_ENCODING) : Charset.defaultCharset());
    }
    public ReverseLineReader(RandomAccessFile rAF, int blockSize, final Charset encoding) throws IOException
    {
        ...
        Charset charset = (encoding == null) ? Charset.defaultCharset() : encoding;
     ...
     *             supported.
     */
    public ReverseLineReader(final File file, final int blockSize, final String encoding) throws IOException {
        this(file, blockSize, encoding == null ? Charset.defaultCharset() : Charset.forName(encoding));
    }
