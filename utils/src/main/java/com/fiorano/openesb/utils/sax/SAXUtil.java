...
//            //handle http
//            if(systemId == null && (baseURI != null && baseURI.toLowerCase().startsWith("http"))){
//                HttpURLConnection httpURLConnection = null;
//                try {
//                    httpURLConnection = (HttpURLConnection) new URL(baseURI).openConnection();
...
//            if (lsInput == null) {
//                if (new File(userCatalogFolder, systemId).exists()) {
//                    lsInput = new DOMInputImpl();
//                    lsInput.setSystemId(systemId);
//                    try {
//                        lsInput.setBaseURI(userCatalogFolder.toURL().toExternalForm());
//                    } catch (MalformedURLException e) {
//                        e.printStackTrace();
//                    }
//                }
