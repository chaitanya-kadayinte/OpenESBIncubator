...
/**
 * This class represents a status event sent by components to Peer Server.
 * A data event is generally sent by component in response to {@link com.fiorano.openesb.microservice.ccp.event.peer.CommandEvent} event from Peer Server.<br><br>
 *
 * @see com.fiorano.openesb.microservice.ccp.event.CCPEventType#STATUS
 *
 * @author FSTPL
 * @version 10
 */
