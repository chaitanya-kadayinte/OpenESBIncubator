...
/**
 *  This class extends DMI Representation of a port of a service instance by defining properties like
 *  destination type, username for proxy, security manager etc.
 * @author FSTPL
 * @version 10
 */
