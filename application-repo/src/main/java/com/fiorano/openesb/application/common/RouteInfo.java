...
/**
 *  RouteInfo class contains some extra information over and above that
 *  contained in Route. RouteInfo is used to add route between two services. It
 *  contains all the information needed for adding a route.
 *
