...
/**
 *  This class represents information about the service and removal status
 *  after it is removed from the repository.
 *
 * @author Manoj
 * @created June 18, 2002
 * @version 2.0
 * @see com.fiorano.openesb.application.DmiObject
 * @see com.fiorano.openesb.application.ServicesRemovalStatus
 * @since Tifosi2.0
 */
