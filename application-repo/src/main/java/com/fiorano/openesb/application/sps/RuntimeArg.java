...
/**
 *  Stores a runtime argument of a service instance. A vector containing all the
 *  runtime arguments of a service instance is contained in
 *  <code>dmi.aps.RuntimeArgs<code>.
 *
 * @author Manoj
