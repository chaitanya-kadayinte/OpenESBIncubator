...
public class OutPort extends DmiObject
{
    ...
    /**
     *  Constructor for the OutPort object
     *
     * @since Tifosi2.0
     */
    public OutPort()
     ...
     *  reply is supported or not, by the outport specified by this object of
     *  <code>OutPort</code>.
     *
     * @return true if synchronous request reply is supported by this OutPort.
    ...
    /**
     *  This interface method is called to get name of the outport specified by
     *  this object of <code>OutPort</code>.
     *
     * @return the name of outport
    ...
    /**
     *  This interface method is called to get the description of the outport,
     *  specified by this object of <code>OutPort</code>.
     *
     * @return The description of outport
    ...
    /**
     *  This interface method is called to get the XSD set for outport,
     *  specified by this object of <code>OutPort</code>.
     *
     ...
     *  objects of <code>Param</code> for this object of <code>OutPort</code>.
     *
     ...
     *  <code>Param</code> for this object of <code>OutPort</code>.
     *
    ...
    /**
     *  This interface method is called to get the javaClass set for this <code>OutPort</code>
     *  .
     *
    ...
    {
        return DmiObjectTypes.OUTPORT;
    }

    /**
     *  Gets the paramWithName attribute of the OutPort object
     *
    ...
    /**
     *  Gets the paramValue attribute of the OutPort object
     *
     * @param name Description of the Parameter
     ...
     *  synchronous request reply is supported or not by the outport, specified
     *  by this object of <code>OutPort</code>.
     *
     * @param isSyncRequestType The boolean specifying whether or not
     *      synchronous request_Reply is supported by this OutPort.
     ...
     *  of outport, specified by this object of <code>OutPort</code>.
     *
     * @param prtName The string to be set as the name of this outport
     * @see #getPortName()
     * @since Tifosi2.0
     */
     ...
     *  description of the outport, specified by this object of <code>OutPort</code>
     *  .
     *
     * @param description The string to be set as description of outport
     * @see #getDescription()
     * @since Tifosi2.0
     */
     ...
     *  outport, specified by this object of <code>OutPort</code>.
     *
     ...
     *  object of <code>OutPort</code>, using the specified XML string.
     *
     ...
     *  , representing extra parameter for outport, to this object of <code>OutPort</code>
     *  .
     *
     * @param param Object of Param to be added to OutPort
     * @see #removeParam(Param)
     * @see #clearParam()
     * @see #getParams()
     * @since Tifosi2.0
     ...
     *  , representing extra parameter for outport, from this object of <code>OutPort</code>
     *  .
     *
     * @param param Object of Param to be removed from OutPort
     * @see #addParam(Param)
     * @see #clearParam()
     * @see #getParams()
     * @since Tifosi2.0
     ...
     *  , from this object of <ode>OutPort</code>.
     *
     * @see #addParam(Param)
     * @see #removeParam(Param)
     * @see #getParams()
    ...
    /**
     *  This method tests whether this object of <code>OutPort</code> has the
    ...
    /**
     *  This method is called to write this object of <code>OutPort</code> to
    ...
    /**
     *  This is called to read this object <code>OutPort</code> from the
    ...
    /**
     *  This utility method is used to compare this object of <code>OutPort</code>
    ...
    {
        if (obj == null || !(obj instanceof OutPort))
        {
            return false;
        }

        OutPort rcvObj = (OutPort) obj;
    ...
    public String toString()
    {
        ...
        strBuf.append("");
        strBuf.append("sps outport Details ");
        strBuf.append("[");
    ...
    protected Node toJXMLString(Document document)
        throws FioranoException
    {
        Node root0 = document.createElement("OutPort");
        ...
        if ("ON_EXCEPTION".equals(m_strPortName))
            standardXSD = Util.equals(CommonSchemas.ERROR_XSD, m_strXSD);
