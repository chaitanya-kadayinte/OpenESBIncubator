...
public class LogModule extends DmiObject
{
    String          m_iMaxTraceLevel;
    String          m_iDefaultTraceLevel;
    String          m_strModuleName;

    /**
     *  Constructor for the LogModule object
     */
    public LogModule()
    {
    }
     ...
     *  of <code>LogModule</code> provides logging information.
     *
     ...
     *  for which this object of <code>LogModule</code> provides logging
     *  information.
     *
     * @return The maximum traceLevel for module.
     * @since Tifosi2.0
     */
    public String getMaxTraceLevel()
    {
    ...
    {
        return DmiObjectTypes.LOG_MODULE;
    }

    /**
     *  This interface method is called to set the specified string as name of module,
     *  for which this object of <code>LogModule</code> provides
     *  logging information.
     *
     ...
     *  level for module, for which this object of <code>LogModule</code>
     ...
     * @since Tifosi2.0
     */
    public void setMaxTraceLevel(String maxTraceLevel)
    {
    ...
    public void setDefaultTraceLevel(String defaultTraceLevel)
    {
     ...
     *  object of <code>LogModule</code>, using the specified XML
     *  string.
     *
     * @param module
...
//        Element module = doc.getDocumentElement();
        if (module != null)
        {
            m_iMaxTraceLevel = module.getAttribute("maxTraceLevel");
            if (module.getAttribute("defaultTraceLevel") != null && !module.getAttribute("defaultTraceLevel").equalsIgnoreCase(""))
                m_iDefaultTraceLevel = module.getAttribute("defaultTraceLevel");
    ...
    /**
     *  This method tests whether this object of <code>LogModule</code>
    ...
    /**
     *  This method is called to write this object of <code>LogModule</code>
        ...
        throws IOException
    {
        ...
        writeUTF(out, m_iMaxTraceLevel);
        writeUTF(out, m_iDefaultTraceLevel);
        writeUTF(out, m_strModuleName);
    }


    /**
     *  This is called to read this object <code>LogModule</code> from
        ...
        throws IOException
    {
        ...
        m_iMaxTraceLevel = readUTF(is);
        m_iDefaultTraceLevel = readUTF(is);
        m_strModuleName = readUTF(is);

        if (m_iMaxTraceLevel == null)
        	m_iMaxTraceLevel = "ALL";

        if (m_iDefaultTraceLevel == null)
            m_iDefaultTraceLevel = "INFO";
    }


    /**
     *  This utility method is used to compare this object of <code>LogModule</code>
    ...
    {
        if (obj == null || !(obj instanceof LogModule))
        {
            return false;
        }

        LogModule rcvObj = (LogModule) obj;
    ...
    public String toString()
    {
        ...
        strBuf.append("");
        strBuf.append("LogModule Details ");
        strBuf.append("[");
