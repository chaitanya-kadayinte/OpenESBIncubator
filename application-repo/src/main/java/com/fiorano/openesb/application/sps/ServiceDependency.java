...
/**
 *  Identifies the service on which the given service is dependent.
 *  This service is non-launchable, and provides some resource files
 *  required by the dependent service to launch.
 *
 *  <p>This information should be provided at the time of service deployment. Object
 *  of <code>Deployment</code> contains a vector of all the service dependencies
 *  of a service.</p>
 *
 * @author Manoj
...
public class ServiceDependency extends DmiObject
{
    ...
    /**
     *  Constructor for the ServiceDependency object
     *
     * @since Tifois2.0
     */
     ...
     *  this <code>ServiceDependency</code>.
     *
     * @return The serviceGUID for this servicedependency.
     ...
     *  this <code>ServiceDependency</code>.
     *
     * @return The version for this servicedependency.
     ...
     *  for this <code>ServiceDependency</code>.
     *
     ...
     *  <code>ServiceDependency</code>.
     *
     * @param version The string to be set as Version for this serviceDependency
     * @see #getVersion()
     * @since Tifois2.0
     */
     ...
     *  <code>ServiceDependency</code>, using the specified XML string.
     *
     * @param depHdr
...
//        Element depHdr = doc.getDocumentElement();
    ...
    /**
     *  This method tests whether this object of <code>ServiceDependency</code>
    ...
    public Node toJXMLString(Document document)
        throws FioranoException
    {
        Node root0 = document.createElement("ServiceDependency");
    ...
    /**
     *  This method is called to write this object of <code>ServiceDependency</code>
    ...
    /**
     *  This is called to read this object <code>ServiceDependency</code>
     ...
     *  <code>ServiceDependency</code> with the specified object.
     *
    ...
    public boolean equals(Object obj)
    {
        ...
        ServiceDependency rcvObj = (ServiceDependency) obj;
     ...
     * of <code>ServiceDependency</code>.
     *
