...
/**
 * This class is a DMI representation of input port of a service instance .It contains methods to access information
 * about the input port of a service such as port name and DTD/XSD for the input port.
 * @author FSTPL
 * @version 10
 */
