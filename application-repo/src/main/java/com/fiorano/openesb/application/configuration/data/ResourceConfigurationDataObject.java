...
/**
 * This class is used to create data objects of resource configuration
 * @author FSTPL
 * @version 10
 *
 * */
public class ResourceConfigurationDataObject extends DataObject {
    private String resourceType;

    /**
     * Default constructor
     */
    public ResourceConfigurationDataObject() {}
     ...
     */
    public ResourceConfigurationDataObject(String name, Label label, ObjectCategory objectCategory, DataType dataType, byte[] data, String resourceType) {
    ...
    public int getObjectID() {
        return DmiObjectTypes.RESOURCE_CONFIGURATION_DATA_OBJECT;
    }
