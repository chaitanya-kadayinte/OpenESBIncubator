...
/**
 *  Contains application design information about service instances and routes
 *  for a specified version of the application.
 *
 * @author Deepak Nohwal
 * @created January 11, 2002
 * @version 1.0
 * @see com.fiorano.openesb.application.aps.ApplicationHeader
 * @see com.fiorano.openesb.application.aps.ServiceInstances
 * @see com.fiorano.openesb.application.aps.WorkflowStartPorts
 * @see com.fiorano.openesb.application.aps.WorkflowExitPorts
 * @see com.fiorano.openesb.application.aps.Routes
 * @see com.fiorano.openesb.application.aps.OnException
