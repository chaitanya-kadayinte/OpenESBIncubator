...
public class WfOutPort extends DmiObject
{
    ...
    /**
     *  This is the constructor of the <code>WfOutPort</code> class.
     *
     * @since Tifosi2.0
     */
    public WfOutPort()
    ...
    /**
     *  This method gets the name of service instance, to which
     *  the corresponding OutPort belongs. This OutPort is represented by this object of
     *  <code>WfOutPort</code>.
     *
    ...
    /**
     *  This method gets the port name of OutPort represented by
     *  this object of <code>WfOutPort</code>.
     *
     * @return name of OutPort
    ...
    {
        return DmiObjectTypes.WF_OUTPORT;
    }


    /**
     *  This method sets the specified string as name of the
     *  service instance, to which the corresponding OutPort belongs. This
     *  OutPort is represented by this object of <code>WfOutPort</code>.
     *
     ...
     *  OutPort, represented by this object of <code>WfOutPort</code>.
     *
     * @param portName the string to be set as name of OutPort
     * @see #getPortName()
     * @since Tifosi2.0
     */
     ...
     *  <code>WfOutPort</code>, using the specified XML string.
     *
     * @param outElement
     ...
     * @since Tifosi2.0
     */
    public void setFieldValues(Element outElement)
        throws FioranoException
    {
//        Document doc = XMLUtils.getDOMDocumentFromXML(xmlString);
//        Element outElement = doc.getDocumentElement();

        if (outElement != null)
        {
            NodeList list = outElement.getChildNodes();
            Node child = null;
    ...
    protected void populate(FioranoStaxParser cursor) throws XMLStreamException,FioranoException
    {
        ...
        if(cursor.markCursor(APSConstants.WORKFLOW_OUT_PORT)){
            ...
            while(cursor.nextElement()){
                ...
                } else if(nodeName.equalsIgnoreCase(APSConstants.WORKFLOW_OUT_PORT_NAME)){
                    nodeValue = cursor.getText();
    ...
    /**
     *  This method tests whether this object of <code>WfOutPort</code>
    ...
    /**
     *  This method writes this object of <code>WfOutPort</code>
    ...
    /**
     *  This method reads this object <code>WfOutPort</code> from the
    ...
    public String toString()
    {
        ...
        strBuf.append("");
        strBuf.append("WorkFlow outport Details ");
        strBuf.append("[");
    ...
    Node toJXMLString(Document document)
        throws FioranoException
    {
        Node root0 = (Node) document.createElement("WfOutPort");
    ...
    {
        //Start WfOutPort
        writer.writeStartElement("WfOutPort");
