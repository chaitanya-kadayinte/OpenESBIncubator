...
public class ApplicationEvent extends SystemEvent{
    ...
    public enum ApplicationEventType {
        APPLICATION_LAUNCHED, APPLICATION_STOPPED, APPLICATION_SYNCHRONIZED, APPLICATION_LAUNCH_STARTED, APPLICATION_SAVED, APPLICATION_UPDATED, APPLICATION_DELETED, APPLICATION_RENAMED
    }
